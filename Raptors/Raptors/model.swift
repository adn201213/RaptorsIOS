...
class Raptor{
    ...
    var tickets:[Ticket]=[Ticket(name:"Balcon Level Ticket",quantity:12,price:1.170),
                          Ticket(name:"Lower Level Ticket",quantity:20,price:10.434),Ticket(name:"CourtSide Ticket",quantity:15,price:27.777)]
